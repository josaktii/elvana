                    ...
                    <div class="col-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <h6 class="box-subtitle">Tabel berisi data Obat di Klinik RH Medika</h6>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example6" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        ...
                                        <tbody>
                                            <?php
                                            $q = $connect->query("SELECT * FROM obat");
                                            $no = 1;
                                            foreach ($q as $du) :
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <a href="edit.php?id=<?= $du['kd_obat'] ?>" class="btn btn-success fa fa-edit"></a>
                                                            <a href="hapus.php?id=<?= $du['kd_obat'] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" class="btn btn-danger fa fa-trash"></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php
