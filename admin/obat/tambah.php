            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h6 class="box-subtitle">Form yang digunakan untuk menambah data Obat di Klinik RH Medika</h6>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="nmobat" class="form-control" required data-validation-required-message="This field is required">
                                                </div>
